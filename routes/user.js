...
//处理注册用户时的表单提交
//当你表单中只有一个文件域的时候可以用upload.single('avatar') avatar指的是上传的文件域的name   req.body req.file
...
/**
 * req.file
 { fieldname: 'avatar',  文件域的字段名
  originalname: '微信扫描了解详情.png', 原始的文件名
  encoding: '7bit', 编码
  mimetype: 'image/png', 内容类型 大类型/小类型
  destination: 'public/', 目标存储路径
  filename: '81ce01576d4de5763cfe50cfcab0c98e', 文件名
  path: 'public\\81ce01576d4de5763cfe50cfcab0c98e', 真实路径
  size: 5482 }
 req.body
